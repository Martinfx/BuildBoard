...
PUB_KEY=""
#UBOOT_MIRROR="https://mirrors.dotsrc.org/armbian-apt/pool/main/l/linux-u-boot-orangepi-r1plus-lts-current/"
UBOOT_MIRROR="https://mirrors.dotsrc.org/armbian-apt/pool/main/l/linux-u-boot-orangepi3-current/"
...
IMG="orangepi-3-$FREEBSD_VER.img"
...
fetch_uboot() {
        UBOOT_NAME="linux-u-boot-current-orangepi3_${UBOOT_VER}_arm64"
	DATA="data.tar.xz"
	UBOOT_PATH="uboot"
