...
PUB_KEY=""
UBOOT_MIRROR="https://mirrors.dotsrc.org/armbian-apt/pool/main/l/linux-u-boot-orangepizero-current/"
#FREEBSD_MIRROR="https://download.freebsd.org/ftp/$FREEBSD_BRANCH/arm64"
FREEBSD_MIRROR="https://download.freebsd.org/snapshots/arm64/1<4.0-CURRENT/"
DEV="md99"
...
fetch_uboot() {
        UBOOT_NAME="linux-u-boot-current-orangepizero_${UBOOT_VER}_armhf"
	DATA="data.tar.xz"
	UBOOT_PATH="uboot"
