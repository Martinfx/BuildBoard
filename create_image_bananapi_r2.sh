...
PUB_KEY=""
UBOOT_MIRROR="https://mirrors.dotsrc.org/armbian-apt/pool/main/l/linux-u-boot-bananapir2-legacy"
...
IMG="bananapir2-$FREEBSD_VER.img"
...
fetch_uboot() {
        UBOOT_NAME="linux-u-boot-legacy-bananapir2_${UBOOT_VER}_armhf"
	DATA="data.tar.xz"
	UBOOT_PATH="uboot"
